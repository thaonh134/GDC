...
{
    public class @=areasname=@MenuManagementController : CustomController
    {
        #region Tree
        ...
        public ActionResult Create(AuthMenu item)
        {
            ...
            try
            {
                ...
                var isExist = AuthMenu.GetById(item.entryid) ;
        ...
        public ActionResult UpdateActiveStatus(int entryid, bool isactive)
        {
            ...
            try
            {
                var isExist =AuthMenu.GetById(entryid);
        ...
        public ActionResult GetByID(int entryid)
        {
            ...
            try
            {
                var data =AuthMenu.GetById(entryid);
