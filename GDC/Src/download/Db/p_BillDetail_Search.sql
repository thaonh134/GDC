...
-- created by: autogen
-- desc: search page
-- test string: p_BillDetail_Search
------------------------------------

IF OBJECT_ID(N'[dbo].[p_BillDetail_Search]') IS NOT NULL
	DROP PROCEDURE [dbo].[p_BillDetail_Search]
GO

CREATE PROCEDURE [p_BillDetail_Search]	
	@Page int = 1  
 ,@PageSize int = 100  
