using @=projectname=@.@=namespacename=@.Models;
...
namespace @=projectname=@.@=namespacename=@.Controllers
{
    public class @=menuname=@@=controllername=@Controller : CustomController
    {
        #region Tree
        public ActionResult Index(string redirectbyajax, string entryid, string actiontype, string fa)
        {
            ...
            return View("@=controllername=@Tree", dict);
        ...
        public ActionResult Read([DataSourceRequest]DataSourceRequest request, string isactive)
        {
            ...
            var userid = 0;
            var data = new @=tablename=@().GetPage(request, whereCondition, isactive, userid);
            return Json(data);
        }
        ...
        public ActionResult FormPopup(string entryid, string entrykey, string redirectbyajax)
        {
            ...
            return View("@=controllername=@Form", dict);


        }

        [HttpPost]
        public ActionResult Create(@=tablename=@ item)
        {
